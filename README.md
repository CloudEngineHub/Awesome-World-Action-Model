...
> Papers are automatically fetched daily from arXiv. Last updated: 2026-08-18

### VLA

| Paper | Date | Code |
|-------|------|------|
| [LIBERO-VIFO: Benchmarking the Capability and Safety of Visual Cue Following in Vision-Language-Action Models](https://arxiv.org/abs/2608.17600v1)<br><small>Zhengyan Qian, Rui Yan et al.</small> | 2026-08-18 |  |
| [EATR-Stereo: Embodiment-Aware Routing of Paired Stereo Evidence for Humanoid Vision-Language-Action Control](https://arxiv.org/abs/2608.17453v1)<br><small>Songwei Wu, Rui Zhao et al.</small> | 2026-08-18 |  |
| [Prism-GRPO: Faster VLA Policy Optimization via Splitting Same-outcome Groups](https://arxiv.org/abs/2608.17423v1)<br><small>Zeyun Deng, Yuzhe Lu et al.</small> | 2026-08-18 |  |
| [Inference-Time Attention Steering for Vision-Language-Action Driving Models](https://arxiv.org/abs/2608.17095v1)<br><small>Darshan Nagendra Prasad, Lars Ullrich et al.</small> | 2026-08-17 |  |
| [$τ_0$-VLA: a Hierarchical Robot Foundation Model with World-Model-Guided Test-Time Computation](https://arxiv.org/abs/2608.16885v1)<br><small>Xiaowei Cai, Yunuo Cai et al.</small> | 2026-08-17 |  |
| [HAF: Adapting Generalist VLAs to Humanoid Whole-Body Loco-manipulation via Hierarchical Action Flow and Spectral Latent RL](https://arxiv.org/abs/2608.16837v1)<br><small>Langzhe Gu, Chengkai Hou et al.</small> | 2026-08-17 |  |
| [FabriMAE I Trust Myself? Self-Evaluating VLA Action Generation with Markov Attention Entropy](https://arxiv.org/abs/2608.16697v1)<br><small> Aniri, Chen Yilin et al.</small> | 2026-08-17 |  |
| [NebulaVLA: A Dual-Frequency Vision-Language-Action Model With Guide Action for Robotic Manipulation](https://arxiv.org/abs/2608.16503v1)<br><small>Cong Zhao, Shuai Tian et al.</small> | 2026-08-17 |  |
...
| [US-VLA: An Ultrasound Vision-Language-Action Model for Embodied Abdomina](https://arxiv.org/abs/2608.16074v1)<br><small>Cheng Zhang, Xingzheng Wu et al.</small> | 2026-08-17 |  |
...
> A broader, continuously-mined index of recent arXiv work that complements the curated highlights above — **177 additional papers**, newest first. Last updated: 2026-08-16. Auto-generated from `data/*.json` by [`scripts/expand_papers.py`](scripts/expand_papers.py); papers already highlighted above are omitted here to avoid duplication.

<details>
<summary><b>VLA — General & Manipulation</b> · 43 papers</summary>

| Paper | Authors | Date | Links |
|-------|---------|------|-------|
| [ViTaR: Visuo-Tactile Residual Adaptation for Foundation VLA Manipulation](https://arxiv.org/abs/2608.15816v1) | Yi Wang, Renjun Wu et al. | 2026-08-16 |  |
| [ForceU-VLA: A Force-Aware Vision-Language-Action Model for Embodied Ultrasound Scanning](https://arxiv.org/abs/2608.15009v1) | Xingzheng Wu, Cheng Zhang et al. | 2026-08-15 |  |
| [Imagining Recovery: Inference-Time Counterfactual Realignment for Vision-Language-Action Models](https://arxiv.org/abs/2608.14822v1) | Yanyan Zhang, Disheng Liu et al. | 2026-08-14 |  |
| [Evolve Vision-Language-Action Model into an Agent with On-the-fly Tool-use](https://arxiv.org/abs/2608.14047v1) | Yi Ding, Yanzhao Yu et al. | 2026-08-14 |  |
| [Decoding Task Progress from VLA Representations](https://arxiv.org/abs/2608.13474v1) | Atiksh Bhardwaj, Edward Weiyi Duan et al. | 2026-08-13 |  |
| [StellaVLA: In-Context Structured Demonstration for Generalizable Vision-Language-Action Models](https://arxiv.org/abs/2608.11671v1) | Siyu Xu, Yunke Wang et al. | 2026-08-12 |  |
...
<details>
<summary><b>VLA — Autonomous Driving</b> · 15 papers</summary>

| Paper | Authors | Date | Links |
|-------|---------|------|-------|
| [SSP: An Event-Matched Syn2Sim2Phy Cross-Domain Evaluation Framework for Autonomous Driving VLA Models](https://arxiv.org/abs/2608.14024v1) | Haojie Feng, Peizhi Zhang et al. | 2026-08-14 |  |
| [FIRE-VLA: Failure-Informed Self-Evolution for Vision-Language-Action Models in Autonomous Driving](https://arxiv.org/abs/2608.13395v1) | Hao Dou | 2026-08-13 |  |
| [Temporal GRPO: Beyond Trajectory-Level Credit in Vision-Language-Action Reinforcement Learning](https://arxiv.org/abs/2608.13026v1) | Yao Zhou, Hang Gao et al. | 2026-08-13 |  |
| [FlashDrive: Flash Vision-Language-Action Inference for Autonomous Driving](https://arxiv.org/abs/2608.12932v1) | Zekai Li, Yihao Liang et al. | 2026-08-13 |  |
| [XCoT-VLA: Executable Chain-of-Thought for Vision-Language-Action Driving](https://arxiv.org/abs/2608.10976v1) |  Foundation Model Team, XPeng Inc | 2026-08-11 |  |
...
| Paper | Authors | Date | Links |
|-------|---------|------|-------|
| [StructRL: Structured Action-Space Exploration for Flow-Based VLAs](https://arxiv.org/abs/2608.15139v1) | Jiarui Yang, Bin Zhu et al. | 2026-08-15 |  |
| [BICPO-VLA: Behavior-Identified Continuation Preference Optimization for Smooth Asynchronous Vision-Language-Action Control](https://arxiv.org/abs/2608.13924v1) | Ming Shang, Yuchen Huang et al. | 2026-08-14 |  |
...
| Paper | Authors | Date | Links |
|-------|---------|------|-------|
| [Algorithm-Architecture Co-Design for Efficient VLA Inference via Speculative Inference and Verification](https://arxiv.org/abs/2608.15636v1) | Chunyu Qi, Zhuoran Song et al. | 2026-08-16 |  |
| [EcoVLA: Energy-Efficient Device-Edge Co-Inference for Vision-Language-Action Models under Real-Time Constraints](https://arxiv.org/abs/2608.15502v1) | Ao Zhou, Bo Dai et al. | 2026-08-16 |  |
| [PhaseLoRA: Control-Regime-Conditioned Low-Rank Adaptation for Continuous-Action Vision-Language-Action Policies](https://arxiv.org/abs/2608.15285v1) | Yufei Guo, Yinan Wu et al. | 2026-08-15 |  |
...
| Paper | Authors | Date | Links |
|-------|---------|------|-------|
| [Bit-Flip Attacks on Vision-Language-Action Models: Action-Decoding Architecture Shapes the Vulnerability](https://arxiv.org/abs/2608.15475v1) | Yudong Gao, Linghan Chen et al. | 2026-08-16 |  |
| [Reflex: Enabling Fast and Predictive Vision-Language-Action Models for Reaction-Critical Manipulation](https://arxiv.org/abs/2608.14379v1) | Yuxuan Chen, Wanruo Zhang et al. | 2026-08-14 |  |
| [UniTexture: Cross-Task Universal Adversarial Textures for Vision-Language-Action Models](https://arxiv.org/abs/2608.13453v1) | Yukun Dai, Mingzhe Dai et al. | 2026-08-13 |  |
